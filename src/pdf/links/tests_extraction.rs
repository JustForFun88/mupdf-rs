...
// ==========================================================================
// Order/override: actions executed left-to-right; later may override earlier.
// ==========================================================================
#[test]
...
#[test]
fn test_ignored_specification_params() {
    ...
    let expected = PdfAction::GoToR {
        ...
        dest: PdfDestination::Page {
            page: 0,
            kind: DestinationKind::FitH { top: Some(255.0) },
        },
    };
    assert_eq!(out, Some(expected));
    ...
    let expected = PdfAction::GoToR {
        ...
        dest: PdfDestination::Page {
            page: 1,
            kind: DestinationKind::FitV { left: Some(56.0) },
        },
    };
    assert_eq!(out, Some(expected));
}
