...
void mupdf_pdf_dict_put_string(fz_context *ctx, pdf_obj *dict, pdf_obj *key, const char *x, mupdf_error_t **errptr)
{
...
const char *mupdf_pdf_dict_get_string(fz_context *ctx, pdf_obj *dict, pdf_obj *key, mupdf_error_t **errptr)
{
